...
export function PharmacyScreen() {
    ...
    if (!subscriptions.length) {
      return (
        <EmptyState
          ...
          subtitle="Create a refill plan to track recurring medicines."
        />
      );
    }
    ...
    return subscriptions.map((item) => {
      ...
      return (
        <TouchableOpacity
          key={entityId}
          activeOpacity={0.88}
          onPress={() => setSelectedSubscriptionId(entityId)}
          style={[styles.listCard, isSelected && styles.listCardSelected]}
        >
          <View style={styles.listCardTop}>
            <View style={styles.listTitleWrap}>
          ...
          <View style={styles.medicineMetaRow}>
            ...
            <Text style={styles.metaValue}>
              {String(firstItem?.intervalDays || '-')} days
            </Text>
          </View>
          <View style={styles.medicineMetaRow}>
            <Text style={styles.metaLabel}>Next Refill</Text>
            <Text style={styles.metaValue}>
              {String(firstItem?.nextRefillDate || item.pausedUntil || 'NA')}
            </Text>
          </View>
        </TouchableOpacity>
      );
  ...
  const renderTrackingCustomerList = () => {
    ...
    if (!customers.length) {
      return (
        <EmptyState
          ...
          subtitle="Add a customer first to start patient tracking."
        />
      );
    }
    ...
    return customers.map((item) => {
      ...
      return (
        <TouchableOpacity
          key={entityId}
          activeOpacity={0.88}
          onPress={() => setSelectedTrackingCustomerId(entityId)}
          style={[styles.listCard, isSelected && styles.listCardSelected]}
        >
          <View style={styles.listCardTop}>
            <View style={styles.listTitleWrap}>
    ...
    return (
      <View style={styles.customerGrid}>
        {filteredCustomers.map((customer) => {
          ...
          return (
            <View
              key={getEntityId(customer)}
              style={[
                styles.customerCard,
                isTablet && styles.customerCardTablet,
              ]}
            >
              <View style={styles.customerHeader}>
                ...
                <View style={styles.customerAgePill}>
                  <Text style={styles.customerAgeText}>
                    {customer.age ? `${customer.age} yrs` : 'Age NA'}
                  </Text>
                </View>
              </View>
